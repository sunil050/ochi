...
function LandingPage() {
  return (
      <div  data-scroll-section data-scroll data-scroll-offset="0, -100%" data-scroll-speed="-1.2" data-scroll-position="top" data-scroll-repeat className="relative is-inview w-full h-screen bg-zinc-900 pt-1">
      ...
      <div data-scroll className="border-t-[1px] border-zinc-800 mt-20 flex justify-between items-center py-5 px-20">
        ...
        <div data-scroll className="start flex items-center gap-5">
          <div className="px-5 py-2 border-[1px] rounded-full border-zinc-400 font-light text-md uppercase">
            start the project
          </div>
          <div data-scroll className="w-10 h-10 flex items-center justify-center border-[1px] border-zinc-500 font-light rounded-full">
